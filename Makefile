...
ALL_EXTENSIONS := hook-coordinator session-lock ui-cosmetics question ralph-loop telegram subagents btw stats file-guards todo async-bash toolcall-nudge browser-control aside primary-agents ultrawork spec-graph planning-cast
